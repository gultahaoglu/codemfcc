...
def test_model(feat_model_path, loss_model_path, part, add_loss, device):
    ...
    test_set = ASVspoof2019("LA", "E:/POST/DeepFakeAudio/DATASETLER/ASV2019/LA/featuresMFCC","E:/POST/DeepFakeAudio/DATASETLER/ASV2019/LA/ASVspoof2019_LA_cm_protocols",part,"MFCC", feat_len=750, padding="repeat")
    ...
    with open(os.path.join(dir_path, 'checkpoint_cm_score.txt'), 'w') as cm_score_file:
        for i, (lfcc, audio_fn, tags, labels) in enumerate((testDataLoader)):
    ...
    eer_cm, min_tDCF = compute_eer_and_tdcf(os.path.join(dir_path, 'checkpoint_cm_score.txt'),path_to_database)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--model_dir', type=str, help="path to the trained model", default="./models_normal")
    ...
    # eer_cm, min_tDCF = compute_eer_and_tdcf(os.path.join(args.model_dir, 'checkpoint_cm_score.txt'),path_to_database)
    ...
    #
    #eer_cm, min_tDCF = compute_eer_and_tdcf(os.path.join(args.model_dir, 'checkpoint_cm_score2.txt'),scoreFile)
    
    #eer_cm, min_tDCF = compute_eer_and_tdcf('./models_Resnext_LFCC_LA/checkpoint_cm_score.txt',path_to_database)
